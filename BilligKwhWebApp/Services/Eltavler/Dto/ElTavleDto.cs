...
namespace BilligKwhWebApp.Core.Dto
{
    public class ElTavleDto
    {
        ...
        public int? EconomicCustomerNumber { get; set; }
        ...
        public int BonusTilgode { get; set; }
        public int? Billeder { get; set; }
